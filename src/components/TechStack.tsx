...
const TechStack = () => {
  ...
  return (
    <section id="tech-stack" className="relative py-24 bg-gradient-to-br from-gray-900 via-black to-gray-900 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-1/6 w-72 h-72 bg-purple-500/5 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/3 right-1/6 w-64 h-64 bg-blue-500/5 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
        ...
        <div className="absolute top-3/4 right-1/4 w-1 h-1 bg-blue-400 rounded-full animate-ping" style={{animationDelay: '3s'}}></div>
        <div className="absolute bottom-1/4 left-3/4 w-1.5 h-1.5 bg-pink-400 rounded-full animate-ping" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-sm font-medium text-purple-light">Technology Stack</span>
          </div>
          ...
          >
            We leverage the latest and most reliable technologies to build robust, scalable, and future-proof applications.
          </p>
        </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 xl:grid-cols-2 gap-4">
                {category.technologies.map((tech, techIndex) => (
                  <div
                    ...
                    style={{transitionDelay: `${800 + categoryIndex * 200 + techIndex * 50}ms`}}
                  >
                    <div className="flex items-center space-x-4">
                      {/* Tech Icon */}
                      <div className={`w-12 h-12 bg-gradient-to-r ${tech.color} rounded-xl flex items-center justify-center text-xl group-hover:scale-110 transition-transform duration-300`}>
                        {tech.icon}
                      </div>
