...
const Features = () => {
  ...
  const features = [
    {
      ...
      description: "Accelerate your project timeline with our agile development process and cutting-edge tools.",
    ...
    },
    {
      ...
      description: "Rigorous testing and code review processes ensure your application is bug-free and performant.",
    ...
    },
    {
      ...
      description: "Beautiful, intuitive interfaces that your users will love and find easy to navigate.",
    ...
    },
    {
      ...
      description: "Scalable applications built for the cloud with modern deployment and infrastructure practices.",
  ...
  return (
    <section id="features" className="relative py-24 bg-gradient-to-br from-gray-900 via-purple-900/20 to-gray-900 overflow-hidden">
      {/* Background Elements */}
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-1/4 right-1/4 w-48 h-48 bg-blue-500/10 rounded-full blur-2xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <span className="text-sm font-medium text-purple-light">Why Choose Infinia</span>
          </div>
          ...
          >
            Everything you need to build, deploy, and scale your applications with confidence and speed.
          </p>
        </div>
